const buildKey = function (scene, parent, props) {
    if (props.type === "white") {
        ...
        */
        ...
        // Create blue color material
        const blueMat = new BABYLON.StandardMaterial("blue");
...
const createScene = async function(engine) {
    ...
    // Register 1 through 2
    var referencePositionX = 0*14;
    for (let register = 3; register <= 4; register++) {
...
BABYLON.SceneLoader.ImportMesh("", "https://raw.githubusercontent.com/thebadlament/floodplains/main/Assets/",
    "CasioCase.gltf",
    scene,
    function (meshes) {
    ...
    frame.parent = piano;
    meshes[0].scaling = new BABYLON.Vector3 (9.7,9.7,9.7);
